![VaultApp](assets/brand/vaultapp-logo-light.png)
...
Der aktuelle stabile Funktionsstand wird als **VaultApp 1.0.4** für macOS ARM, macOS Intel, Windows x64 und Linux x64 veröffentlicht. Die stabilen Pakete werden ausschließlich durch GitHub Actions erzeugt und gemeinsam mit SHA-256-Prüfsummen im GitHub Release bereitgestellt. Version 1.0.1 unterdrückt unter Windows sichtbare PowerShell-Fenster und verwendet eindeutige Volume-GUIDs. Version 1.0.2 verarbeitet die Windows-Datenträgererkennung auch dann korrekt, wenn PowerShell bei genau einem angeschlossenen Datenträger ein einzelnes JSON-Objekt statt einer Liste zurückgibt. Version 1.0.3 trennt verschiedene Datenträger auch dann dauerhaft, wenn Windows ihnen nacheinander denselben Laufwerksbuchstaben zuweist. Version 1.0.4 erzeugt das Windows-Paket als echtes, vor dem Upload geprüftes ZIP-Archiv.
